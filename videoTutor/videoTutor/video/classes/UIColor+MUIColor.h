...
/// если alpha == 1 - то вернется clearColor; "хак" для пресетов
 ...
 * @param The brightness (or value) component of the color object in the HSB color space, specified as a value from 0.0 to 1.0.
