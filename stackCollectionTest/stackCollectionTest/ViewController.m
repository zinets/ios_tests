...
- (void)viewDidLoad {
    ...
    [btn setTitle:@"images" forState:(UIControlStateNormal)];
    [btn sizeToFit];
    [btn addTarget:self action:@selector(loadImages) forControlEvents:(UIControlEventTouchUpInside)];
    UIBarButtonItem *barBtn1 = [[UIBarButtonItem alloc] initWithCustomView:btn];
    
    btn = [UIButton buttonWithType:(UIButtonTypeSystem)];
    [btn setTitle:@"urls" forState:(UIControlStateNormal)];
    [btn sizeToFit];
    [btn addTarget:self action:@selector(loadUrls) forControlEvents:(UIControlEventTouchUpInside)];
    UIBarButtonItem *barBtn2 = [[UIBarButtonItem alloc] initWithCustomView:btn];
